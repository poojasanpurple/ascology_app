...
class KundaliMatchMakingPage extends StatefulWidget {
  // const Register({Key? key}) : super(key: key);

  @override
  _KundaliMatchMakingPageState createState() => _KundaliMatchMakingPageState();
}

class _KundaliMatchMakingPageState extends State<KundaliMatchMakingPage> {
  ...
  String res_ashtakoota ='',manglikstatus ='',
      res_male_manglik_per='',res_female_manglik_per='',res_match_report='';
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      ...
      Scaffold(
        ...
        appBar: AppBar(
          title: Text('Kundali Match ', style: TextStyle(
            color: Colors.white,
...
*/
    ...
    return
      ...
      Container(
        child: Column(
          children: [
            SizedBox(height: 20),
            Text('Match report',style: TextStyle(fontSize: cf.Size.blockSizeHorizontal * 3.5,color: Colors.red,fontFamily: 'Poppins')),
                          ...
                          children: [
                            ...
                            TableRow( children: [
                              Column( crossAxisAlignment: CrossAxisAlignment.start,mainAxisSize: MainAxisSize.max,
                                  mainAxisAlignment: MainAxisAlignment.start,children:[Text('Ashtakoota',textAlign: TextAlign.left,style: TextStyle(fontSize: cf.Size.blockSizeHorizontal * 2.8,color: Colors.red,fontFamily: 'Poppins'))]),
                              Column(crossAxisAlignment: CrossAxisAlignment.start,mainAxisSize: MainAxisSize.max,
                                  mainAxisAlignment: MainAxisAlignment.start,children:[Text('${res_ashtakoota}',style: TextStyle(fontSize: cf.Size.blockSizeHorizontal * 2.8,color: Colors.black,fontFamily: 'Poppins'))]),
                            ]),

                            TableRow( children: [
                              Column(crossAxisAlignment: CrossAxisAlignment.start,mainAxisSize: MainAxisSize.max,
                                  mainAxisAlignment: MainAxisAlignment.start,children:[Text('Manglik',style: TextStyle(fontSize: cf.Size.blockSizeHorizontal * 2.8,color: Colors.red,fontFamily: 'Poppins'))]),
                              Column(crossAxisAlignment: CrossAxisAlignment.start,mainAxisSize: MainAxisSize.max,
                                  mainAxisAlignment: MainAxisAlignment.start,children:[Text(' ${manglikstatus}',style: TextStyle(fontSize: cf.Size.blockSizeHorizontal * 2.8,color: Colors.black,fontFamily: 'Poppins'))]),
                            ]),
                            TableRow( children: [
                              Column(crossAxisAlignment: CrossAxisAlignment.start,mainAxisSize: MainAxisSize.max,
                                  mainAxisAlignment: MainAxisAlignment.start,children:[Text('Male percentage ',style: TextStyle(fontSize: cf.Size.blockSizeHorizontal * 2.8,color: Colors.red,fontFamily: 'Poppins'))]),
                              Column(crossAxisAlignment: CrossAxisAlignment.start,mainAxisSize: MainAxisSize.max,
                                  mainAxisAlignment: MainAxisAlignment.start,children:[Text(' ${res_male_manglik_per}',style: TextStyle(fontSize: cf.Size.blockSizeHorizontal * 2.8,color: Colors.black,fontFamily: 'Poppins'))]),
                            ]),
                            TableRow( children: [
                              Column(crossAxisAlignment: CrossAxisAlignment.start,mainAxisSize: MainAxisSize.max,
                                  mainAxisAlignment: MainAxisAlignment.start,children:[Text('Female percentage',style: TextStyle(fontSize: cf.Size.blockSizeHorizontal * 2.8,color: Colors.red,fontFamily: 'Poppins'))]),
                              Column(crossAxisAlignment: CrossAxisAlignment.start,mainAxisSize: MainAxisSize.max,
                                  mainAxisAlignment: MainAxisAlignment.start,children:[Text('${res_female_manglik_per}',style: TextStyle(fontSize: cf.Size.blockSizeHorizontal * 2.8,color: Colors.black,fontFamily: 'Poppins'))]),
                            ]),

                            TableRow( children: [
                              Column(crossAxisAlignment: CrossAxisAlignment.start,mainAxisSize: MainAxisSize.max,
                                  mainAxisAlignment: MainAxisAlignment.start,children:[Text('Conclusion',style: TextStyle(fontSize: cf.Size.blockSizeHorizontal * 2.8,color: Colors.red,fontFamily: 'Poppins'))]),
                              Column(crossAxisAlignment: CrossAxisAlignment.start,mainAxisSize: MainAxisSize.max,
                                  mainAxisAlignment: MainAxisAlignment.start,children:[Text('${res_match_report}',style: TextStyle(fontSize: cf.Size.blockSizeHorizontal * 2.8,color: Colors.black,fontFamily: 'Poppins'))]),
                            ]),
  ...
  void send_match_making() async {
    ...
    final url = Uri.parse('https://json.astrologyapi.com/v1/match_making_report');
    ...
    print(matchmaking_response.toString());

    if(matchmaking_response['status']== true) {
      if (matchmaking_response['ashtakoota']['status'] == true) {
        res_ashtakoota =
            (matchmaking_response['ashtakoota']['received_points']).toString();
      }

      else {
        res_ashtakoota = "N/A";
      }
      if (matchmaking_response['manglik']['status'] == true) {
        manglikstatus = 'Yes';
        res_male_manglik_per =
            (matchmaking_response['manglik']['male_percentage']).toString();
        res_female_manglik_per =
            (matchmaking_response['manglik']['female_percentage']).toString();
      }
      else {
        manglikstatus = 'No';
        res_male_manglik_per = "N/A";
        res_female_manglik_per = "N/A";
      }

      res_match_report =
          (matchmaking_response['conclusion']['match_report']).toString();
    }
    else
      {
