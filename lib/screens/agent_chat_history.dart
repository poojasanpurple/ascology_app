...
class AgentChatHistory extends StatefulWidget {
  // const Login({Key key}) : super(key: key);

  @override
  _AgentChatHistoryState createState() => _AgentChatHistoryState();
}

class _AgentChatHistoryState extends State<AgentChatHistory> {
  ...
  String session_user_id,session_user_mobile,hist_fromdate,hist_todate,search_text,pass_fromdate,pass_todate,agent_ext;
...
*/
  ...
  getagentchathistory() async {
    ...
    agent_ext = logindata.getString('agent_ext');


    LoginApiClient api = LoginApiClient();
    AgentChatHistRequest requestModel = new AgentChatHistRequest();

    requestModel.extension = agent_ext;

    chathistorylist = await api.getagentchathistory(requestModel);
    setState(() {
