...
class Astrologers_NumeroPage extends StatefulWidget {
  ...
  @override
  _Astrologers_NumeroPageState createState() => _Astrologers_NumeroPageState();
}

class _Astrologers_NumeroPageState extends State<Astrologers_NumeroPage> {
...
//  List searchlist = [];
  ...
  String send_agent_id,astro_mobile, astro_extension,got_agent_id,astro_agentname,astro_img,session_user_id,
      session_user_mobile;
                        ...
                        //childAspectRatio: 2
                              ...
                              itemBuilder: (context, index) {
                                if (searchlist != null &&
                                  ...
                                  var astro_call_status_numero = searchlist[index]
                                      .PhoneCallStatus;
                                  var astro_chat_status_numero = searchlist[index]
                                      .ChatStatus;
                                                                        ...
                                                                        ElevatedButton(
                                                                          style: ElevatedButton
                                                                              ...
                                                                              fixedSize:  Size(
                                                                                  70,
                                                                                  4),
                                                                              primary: (astro_call_status_numero ==
                                                                                  "1")
                                                                                  ? Colors
                                                                                  .green
...
*/
                                                                        ...
                                                                        ElevatedButton(
                                                                          style: ElevatedButton
                                                                              ...
                                                                              fixedSize:  Size(
                                                                                 70,4),
                                                                              primary: (astro_chat_status_numero ==
                                                                                  "1")
                                                                                  ? Colors
                                                                                  .green
  ...
  void sendfollow(String agent_id) async {
    ...
    if(userModel.status == true) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (context) => Astrologers_NumeroPage()), // this mymainpage is your page to refresh
