...
class AgentVerifyOtp extends StatefulWidget {

  String mobile, usertype;

  AgentVerifyOtp({this.mobile});


  @override
  _AgentVerifyOtpState createState() => _AgentVerifyOtpState();
}

class _AgentVerifyOtpState extends State<AgentVerifyOtp> {
  ...
  Widget build(BuildContext context) {
   ...
   // user_type = widget.usertype;
    ...
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
          title: Text('Agent Verify Otp', style: TextStyle(
              color: Colors.white,
              fontSize: 22
          ),) ,
...
*/
  ...
  void getuserotp(BuildContext context) async {
    ...
    if ( verify_otp!=null) {
      ...
      print(verify_mobile);
      AgentOtpResponseModel userModel =
      await _loginApiClient.agentverifyotp(userVerifyOtp);
       ...
       /* if(user_type=="User") {
          ...
          *//* Navigator.push(
          ...
          Navigator.push(context,
              MaterialPageRoute(
                builder: (context) {
                  return UserChangePassword(mobile: verify_mobile, usertype :"User") ;
                },
              ));
      ...
      /*  if(user_type=="Agent")
        {*/
          ...
          Navigator.push(context,
              MaterialPageRoute(
                builder: (context) {
                  return AgentChangePassword(mobile: verify_mobile) ;
                },
              ));
      //  }
...
/*  setProgressVisibility = false;
  ...
  void sendmsgotp(BuildContext context) async {
    ...
    if(smsotp_count <=3)
    {
      ...
      OtpResponseModel userModel = await _loginApiClient.agent_resendotp(
          loginRequestModel);
      print("!Q!Q!QQ!Q!Q!Q $userModel");
      if (userModel.status == true) {
