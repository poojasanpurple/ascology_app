...
class Astrologers_PsychoPage extends StatefulWidget {


  // UserVerifyOtp({this.mobile,this.usertype});

  @override
  _Astrologers_PsychoPageState createState() => _Astrologers_PsychoPageState();
}

class _Astrologers_PsychoPageState extends State<Astrologers_PsychoPage> {
...
*/
     Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (context) => Astrologers_PsychoPage()), // this mymainpage is your page to refresh
          ...
          child: isLoading
            ...
            Flexible(
               ...
               /* LayoutBuilder(
                ...
                ListView.separated(
                  // scrollDirection: ,
                    /*gridDelegate: new SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 2, crossAxisSpacing: 10, mainAxisExtent: 200,
                      //childAspectRatio: 2
                    ),
*/
                   // itemCount: astrologerslist.length,
                    ...
                    //  if(astrologerslist!=null && astrologerslist.length!=0)
                      if(searchlist!=null && searchlist.length!=0)
                      {
                        ...
                        var astro_call_status_psycho = searchlist[index].PhoneCallStatus;
                        var astro_chat_status_psycho = searchlist[index].ChatStatus;
                         astro_mobile = searchlist[index].mob;
                         astro_extension = searchlist[index].extension;
                          follow_param =  searchlist[index].follow;
                                                                      ...
                                                                      children: [
                                                                        ElevatedButton(
                                                                          style: ElevatedButton
                                                                              ...
                                                                              fixedSize:  Size(
                                                                                  70,4),
                                                                              primary: (astro_call_status_psycho ==
                                                                                  "1")
                                                                                  ? Colors
                                                                                  .green
...
*/
                                                                        ...
                                                                        ElevatedButton(
                                                                          style: ElevatedButton
                                                                              ...
                                                                              fixedSize:  Size(
                                                                                  70,4),
                                                                              primary: (astro_chat_status_psycho ==
                                                                                  "1")
                                                                                  ? Colors
                                                                                  .green
