...
class PremiumAstrologersPage extends StatefulWidget {
  ...
  @override
  _PremiumAstrologersPageState createState() => _PremiumAstrologersPageState();
}

class _PremiumAstrologersPageState extends State<PremiumAstrologersPage> {
...
//  List searchlist = [];
  ...
  String send_agent_id,astro_mobile,follow_param,astro_extension,got_agent_id,astro_agentname,astro_img,session_user_id,session_user_mobile;
  ...
  getpremiumastrologers() async {
    ...
    astrologerslist = await api.getpremiumdata(requestModel);
  ...
  void sendfollow(String agent_id) async {
    ...
    if(userModel.status == true) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (context) => PremiumAstrologersPage()), // this mymainpage is your page to refresh
  ...
  Widget build(BuildContext context) {
    ...
    return
      SafeArea(child:
        Scaffold(
      appBar: AppBar(
        title: Text('Premium astrologers', style: TextStyle(
            color: Colors.white,
