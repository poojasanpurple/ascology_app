...
class AstrologerDetailsNew
{
  ...
  AstrologerDetailsNew();

  factory AstrologerDetailsNew.fromJson(Map<String, dynamic> json) {
    AstrologerDetailsNew astrologerDetails = new AstrologerDetailsNew();
